...
const commentState = vi.hoisted(() => ({
  items: [
    { key: 'real-comment', taskId: 'task-live', projectId: 'project-a', comment: { id: 'real-comment', content: '実際の確認コメント', createdAt: new Date(2026, 8, 3, 9), attachments: [] }, authorName: '確認担当者', listName: '展示会の準備', task: { id: 'task-live', projectId: 'project-a', projectName: '実プロジェクト', title: '実タスク' } },
