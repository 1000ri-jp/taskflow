...
export default function MeetingIntakeDialog({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
  ...
  return <MeetingIntake projects={projects} tasks={allProjectTasks} disabled={isLoading || !!error} launcherOnly open={open} onOpenChange={onOpenChange} notice={notice} />;
}
